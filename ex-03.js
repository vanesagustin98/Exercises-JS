function distributeGifts(packOfGifts, reindeers) {
    let pesoRegalos = packOfGifts.reduce((total, regalo) => total + regalo.length, 0)
    let capacidadRenos = reindeers.reduce((total, peso) => total + peso.length, 0)
    return Math.floor((capacidadRenos * 2) / pesoRegalos)
}
